...
window.onload = function() {
  ...
  document.getElementById('ws-avatar-display').appendChild(Game.getDisplay('main').getContainer());
  document.getElementById('ws-main-display').appendChild(Game.getDisplay('main').getContainer());
  document.getElementById('ws-message-display').appendChild(Game.getDisplay('main').getContainer());
